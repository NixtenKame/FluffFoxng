...
class UploadWhitelistTest < ActiveSupport::TestCase
  context "A upload whitelist" do
    setup do
      ...
      # domain regex matches any subdomain of nixten.ddns.net
      # path regex matches /data/ followed by anything
      @whitelist = create(:upload_whitelist,
                          domain: "nixten.ddns.net:9001", # rubocop:disable Style/RedundantStringEscape
    ...
    should "succeed for valid URLs" do
      assert_equal([true, nil], UploadWhitelist.is_whitelisted?("https://nixten.ddns.net:9001/data/123.png"))
    end
    ...
    should "fail for invalid URLs" do
      ...
      assert_equal([false, "example.com not in whitelist"], UploadWhitelist.is_whitelisted?("https://example.com/test?=https://nixten.ddns.net:9001/data/123.jpeg"))
      assert_equal([false, "nixten.ddns.net:9001 is in whitelist, but path /other/123.png is not allowed."], UploadWhitelist.is_whitelisted?("https://nixten.ddns.net:9001/other/123.png"))
    end
