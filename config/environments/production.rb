# ARE YOU FUCKING SERIOUS, GIT? I LITERALLY INCLUDED THIS FILE IN THE .GITIGNORE AND YOU STILL COMMITTED THE DAMN FILE... FUCK YOU, GIT LIKE THAT ONE TIME WHEN I HAD THE .ENV FILE IN ONE OF MY REPO'S IN THE .GITIGNORE AND YOU STILL COMMITTED THE FUCKING FILE WTF!!!!!
...
Rails.application.configure do
  ...
  # Optional: stream Rails logs to container stdout for terminal visibility.
